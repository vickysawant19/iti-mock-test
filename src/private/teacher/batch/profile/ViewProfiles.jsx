...
const ViewProfiles = ({ students, batchId }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5 gap-3">
        {filteredStudents.map((student, index) => (
          <div
            key={student.userId || index}
            className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 overflow-hidden flex flex-col"
          >
            ...
            <div className="px-3 py-2 grid grid-cols-1 gap-1.5 bg-gray-50/50 dark:bg-gray-800/20 border-y border-gray-100 dark:border-gray-800">
            ...
            <div className="mt-auto p-2 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 grid grid-cols-2 gap-1.5">
              <button
                onClick={() => setViewProfileUserId(student.userId)}
                className="flex items-center justify-center gap-1.5 py-1.5 px-2 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400 transition-all active:scale-95 border border-transparent hover:border-blue-100 dark:hover:border-blue-800"
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 py-1.5 px-2 rounded-xl hover:bg-green-50 dark:hover:bg-green-900/20 text-green-600 dark:text-green-400 transition-all active:scale-95 border border-transparent hover:border-green-100 dark:hover:border-green-800"
                title="Call Student"
              >
