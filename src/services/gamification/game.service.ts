...
import { Query, tablesDb } from "../core/appwriteClient";
import subjectService from "../academic/subjectService";
...
export class GameService extends DatabaseService {
  ...
  async getModulesForTrade(tradeId: string): Promise<any[]> {
    try {
      const subjectService = (await import("../academic/subjectService")).default;
      const moduleServices = (await import("../academic/moduleServices")).default;
