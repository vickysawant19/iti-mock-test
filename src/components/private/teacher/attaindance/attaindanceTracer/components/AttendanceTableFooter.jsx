...
const AttendanceTableFooter = ({
  ...
  return (
    <tfoot className="bg-linear-to-r from-gray-100 to-gray-200">
      <tr className="font-bold">
        ...
        {monthDates.map((date) => {
          ...
          return (
            <td
              ...
              className={`py-3 px-2 border border-gray-300 text-center text-green-600 w-16 min-w-16 max-w-16 ${
                isHoliday ? "bg-red-50" : ""
              }`}
            >
        ...
        <td
          colSpan="8"
          className="py-3 px-3 border border-gray-300 w-24 min-w-24 max-w-24"
        ></td>
      </tr>
      <tr className="font-bold">
        <td className="sticky left-0 py-3 px-4 border border-gray-300 text-indigo-700 bg-gray-100 z-10 w-48 min-w-48 max-w-48">
        ...
        {monthDates.map((date) => {
          ...
          return (
            <td
              ...
              className={`py-3 px-2 border border-gray-300 text-center text-red-600 w-16 min-w-16 max-w-16 ${
                isHoliday ? "bg-red-50" : ""
              }`}
            >
        ...
        {monthDates.map((date) => {
          ...
          return (
            <td
              ...
              className={`py-3 px-2 border border-gray-300 text-center text-indigo-600 w-16 min-w-16 max-w-16 ${
                isHoliday ? "bg-red-50" : ""
              }`}
            >
