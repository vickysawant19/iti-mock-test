          ...
          {selectedPaper?.submitted ? (
            ...
            module.assessmentPaperId && (
              <Link
                ...
                className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-md transition-colors focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Attend Exam
              </Link>
            )
