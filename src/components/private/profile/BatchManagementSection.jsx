    ...
    <div className="bg-white p-5 rounded-lg shadow-sm mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <div className="mt-4">
            <div className="flex items-center mb-1">
              <PlusCircle size={18} className="text-gray-500 mr-1" />
              <label className="text-gray-600">Add Batch to List</label>
            </div>
            <div className="flex items-center">
              <select
                className="w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2"
        ...
        <div>
          <div className="flex items-center mb-1">
            <Clipboard size={18} className="text-gray-500 mr-1" />
            <label className="text-gray-600">
      ...
      {(watch("allBatchIds") || []).length > 0 && (
        <div className="mt-4">
          <h3 className="font-medium text-gray-700 mb-2">Selected Batches:</h3>
