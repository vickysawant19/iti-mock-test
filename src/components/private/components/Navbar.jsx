    ...
    >
      <CollapsibleTrigger asChild>
        ...
        >
          ...
          <ChevronRight className={`w-4 h-4 transition-transform ${expandedGroup === groupKey ? "rotate-90" : ""}`} />
        </Button>
      </CollapsibleTrigger>
        ...
        <div className="flex h-14 items-center justify-between px-4">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="left" className="p-0" onInteractOutside={() => setIsOpen(false)}>
                <div className="flex flex-col h-full">
                  <div className="border-b p-4">
                    <div className="flex items-center gap-2">
                      <img src={logo} alt="ITI" className="h-6 w-6 rounded-md" />
                      <h2 className="font-semibold">{currentHeading || "Navigation"}</h2>
                    </div>
                  </div>
          ...
          {/* Desktop Navigation with Collapsible Menu */}
          <div className="hidden md:flex items-center">
            ...
            {/* Keep Home always visible in navbar */}
            {menuConfig.map((configItem) => {
              if (configItem.items && configItem.items.length <= 2) {
                  ...
                  if (item.label === "Home") {
                    return (
                      <NavLink
                        ...
                        to={item.path}
                        className={({ isActive }) => 
                          `ml-2 text-sm font-medium transition-colors hover:text-primary ${
