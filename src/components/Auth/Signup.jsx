...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col lg:flex-row">
      {/* Left Section - Image (hidden on small screens, half width on large) */}
      <div className="hidden lg:block lg:w-1/2 h-screen">
        <img
          src={students}
          alt="Students"
          className="object-cover w-full h-full light:block dark:hidden"
        />
        <img
          src={students} // replace with a dark-mode-specific image if available
          alt="Students (dark)"
          className="object-cover w-full h-full hidden dark:block"
        />
      </div>

      {/* Right Section - Signup Form (full width on small, half on large) */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-xl bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 lg:p-12">
