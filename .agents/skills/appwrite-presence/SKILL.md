---
name: appwrite-presence
description: Appwrite Presences API skill. Use when tracking user online/offline presence states, managing WebSocket heartbeats, listing active sessions, and subscribing to status change events.
---
...
- **Collaboration cursors** that show which document or secti
<truncated 16077 bytes>
